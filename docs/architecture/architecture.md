...
like Installations, Targets etc. in so-called customer namespaces. More about customer namespaces could be found in
[usage/NamespaceRegistrations](../usage/Namespaceregistration.md)
